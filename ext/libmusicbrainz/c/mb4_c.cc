...
#define MB4_C_EXT_GETTER(PROP1, PROP2) \
  ...
  MB4_C_CLONE(Collection,collection)
  ...
  MB4_C_CLONE(FreeDBDisc,freedbdisc)
  ...
  MB4_C_CLONE(LabelInfo,labelinfo)
...
unsigned char mb4_medium_contains_discid(Mb4Medium Medium, const char *DiscID)
{
  ...
  MB4_C_CLONE(NameCredit,namecredit)
  ...
  MB4_C_CLONE(NonMBTrack,nonmbtrack)
...
tQueryResult mb4_query_get_lastresult(Mb4Query o)
{
  ...
  MB4_C_CLONE(Recording,recording)
  ...
  MB4_C_OBJ_GETTER(Release,release,CollectionList,collectionlist)
...
Mb4MediumList mb4_release_media_matching_discid(Mb4Release Release, const char *DiscID)
{
  ...
  MB4_C_CLONE(ReleaseGroup,releasegroup)
  ...
  MB4_C_CLONE(TextRepresentation,textrepresentation)
  ...
  MB4_C_CLONE(AliasList,alias_list)

  MB4_C_LIST_GETTER(Annotation,annotation)
  MB4_C_CLONE(AnnotationList,annotation_list)

  MB4_C_LIST_GETTER(Artist,artist)
  MB4_C_CLONE(ArtistList,artist_list)

  MB4_C_LIST_GETTER(Attribute,attribute)
  MB4_C_CLONE(AttributeList,attribute_list)

  MB4_C_LIST_GETTER(CDStub,cdstub)
  MB4_C_CLONE(CDStubList,cdstub_list)

  MB4_C_LIST_GETTER(Collection,collection)
  MB4_C_CLONE(CollectionList,collection_list)

  MB4_C_LIST_GETTER(Disc,disc)
  MB4_C_CLONE(DiscList,disc_list)

  MB4_C_LIST_GETTER(FreeDBDisc,freedbdisc)
  MB4_C_CLONE(FreeDBDiscList,freedbdisc_list)

  MB4_C_LIST_GETTER(ISRC,isrc)
  MB4_C_CLONE(ISRCList,isrc_list)

  MB4_C_LIST_GETTER(Label,label)
  MB4_C_CLONE(LabelList,label_list)

  MB4_C_LIST_GETTER(LabelInfo,labelinfo)
  MB4_C_CLONE(LabelInfoList,labelinfo_list)

  MB4_C_LIST_GETTER(Medium,medium)
  MB4_C_CLONE(MediumList,medium_list)
  MB4_C_INT_GETTER(MediumList,medium_list,TrackCount,trackcount)

  MB4_C_LIST_GETTER(NameCredit,namecredit)
  MB4_C_CLONE(NameCreditList,namecredit_list)

  MB4_C_LIST_GETTER(NonMBTrack,nonmbtrack)
  MB4_C_CLONE(NonMBTrackList,nonmbtrack_list)

  MB4_C_LIST_GETTER(PUID,puid)
  MB4_C_CLONE(PUIDList,puid_list)

  MB4_C_LIST_GETTER(Recording,recording)
  MB4_C_CLONE(RecordingList,recording_list)

  MB4_C_LIST_GETTER(Relation,relation)
  MB4_C_CLONE(RelationList,relation_list)
  MB4_C_STR_GETTER(RelationList,relation_list,TargetType,targettype)

  MB4_C_LIST_GETTER(Release,release)
  MB4_C_CLONE(ReleaseList,release_list)

  MB4_C_LIST_GETTER(ReleaseGroup,releasegroup)
  MB4_C_CLONE(ReleaseGroupList,releasegroup_list)

  MB4_C_LIST_GETTER(Tag,tag)
  MB4_C_CLONE(TagList,tag_list)

  MB4_C_LIST_GETTER(Track,track)
  MB4_C_CLONE(TrackList,track_list)

  MB4_C_LIST_GETTER(UserTag,usertag)
  MB4_C_CLONE(UserTagList,usertag_list)

  MB4_C_LIST_GETTER(Work,work)
  MB4_C_CLONE(WorkList,work_list)
